        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="animate-fade-in-left">
            ...
            <p className="mt-6 text-sm text-muted-foreground">
              I enjoy turning raw data into clear, actionable stories that support business and research goals.
            </p>
          </div>

          {/* Right Content - Soft Skills (no percentage bars) */}
          <div className="animate-fade-in-right">
            <h3 className="text-xl font-semibold mb-6 text-gradient-primary text-center">Soft Skills</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { skill: 'Problem-solving', icon: '🧩', blurb: 'Breaks down complex problems into clear, actionable steps.' },
                { skill: 'Analytical Thinking', icon: '🧠', blurb: 'Finds patterns and insights from data to inform decisions.' },
                { skill: 'Team Collaboration', icon: '🤝', blurb: 'Works smoothly across teams to deliver outcomes on time.' },
                { skill: 'Communication', icon: '💬', blurb: 'Explains technical ideas simply for non-technical audiences.' },
                { skill: 'Adaptability', icon: '🔄', blurb: 'Learns quickly and adjusts to new tools and workflows.' },
              ].map((item, index) => (
